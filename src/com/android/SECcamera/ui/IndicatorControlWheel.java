...
package com.android.SECcamera.ui;

import com.android.SECcamera.PreferenceGroup;
...
//    private static final int FIRST_LEVEL_START_DEGREES = 74;//org
...
//    private static final int SECOND_LEVEL_END_DEGREES = 300;
    ...
    private static final int ZOOM_ICON_DEFAULT_DEGREES = 180;
	 private static final int MAX_ZOOM_CONTROL_DEGREES =280;
...
//        Log.w(TAG, "yyd-  controlWheel-presetFirstLevelChildRadians, mStartVisibleRadians-degrees= " + degrees );
...
//        Log.w(TAG, "yyd-  controlWheel-presetFirstLevelChildRadians, count =" + count 
//			+ ", sectors = " + sectors + ", sectorDegrees =" + sectorDegrees +", degrees= " + degrees);
